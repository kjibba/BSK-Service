// Lightweight inline SVG icons for buttons and headers
// Keep size small and stroke consistent for readability on mobile
...
export function IconBack({ size = 16, className = '' }){
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
